...
-- Generic arms skills
arm_skill.use("herb_skills.follow_take", "follow_take", "newmanipapp/FollowTake")
arm_skill.use("herb_skills.follow_give", "follow_give", "newmanipapp/FollowGive")
arm_skill.use("herb_skills.follow_teleop", "follow_teleop", "newmanipapp/FollowTeleop")
...
arm_skill.use("herb_skills.ft_handoff", "ft_handoff", "newmanipapp/FTHandOff")
