...
action_skill.use("herb_skills.pose_goto", "/posegraph/goto", "posegraphapplet/goto")
action_skill.use("herb_skills.pose_fromto", "/posegraph/gofromto", "posegraphapplet/gofromto")
